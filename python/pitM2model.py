...
class PitM2Model(nn.Module):
    ...
    def __init__(self, seq_n_features, lstm_size, lstm_layers, lstm_dropout, 
        ...
        """
        super(PitM2Model, self).__init__()
...
if __name__ == "__main__":
    ...
    SUMMARY_PATH = '/home/user/notebooks/runs/pitM2'
    
    # run specific model path
    MODEL_PATH = adjustModelPath('/home/user/notebooks/data/model/pitM2', False);
    print('Model will be saved in: '+MODEL_PATH)
    MODEL_SAVED = MODEL_PATH + '/pitM2.pth'
